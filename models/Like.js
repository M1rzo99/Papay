...
class Like {
  ...
  async checkLikeExictance(like_ref_id) {
    try {
      const like = await this.likeModel
        ...
        .exec();
      return !!like; // ? true : false degan mano
    } catch (err) {
      throw err;
    }
  }
  ...
  async insertMemberLike(like_ref_id, group_type) {
    try {
      ...
      // modify target likes count  1ga oshirish kk
      await this.modifyItemLikeCounts(like_ref_id, group_type, 1);
        ...
        case "product":
          await this.productModel
            .findByIdAndUpdate(
              ...
              { $inc: { product_likes: modifier } } // viewsni 1 taga oshirib beradi.
            )
            .exec();
          break;
        ...
        default:
          await this.boArticleModel
            .findByIdAndUpdate(
              ...
              { $inc: { art_likes: modifier } } // viewsni 1 taga oshirib beradi.
            )
            .exec();
          break;
      }
